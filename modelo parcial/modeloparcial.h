...
void buscarPorPatente(sVehiculos[],sPersona[],int,int);
void mostrarPatentes(sVehiculos vehiculos[],int cantidadVehiculos);
int buscarNombrePorPatente(sVehiculos vehiculo [], sPersona[] ,int cantidadVehiculos,int);
void mostrarUnaPersona(sPersona);
void listaDeDueniosConSusAutos(sPersona[],sVehiculos[],int cantidadPersonas, int cantidadVehiculos);
void mostrarUnAutito(sVehiculos);
void mostrarListaAutos(sVehiculos [], int cantidadAutos);
